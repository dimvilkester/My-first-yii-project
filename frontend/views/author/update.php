...
$this->title = 'Update author #ID: ' .Html::encode($model->id);
...
<div class="body-content">
    <div class="col-lg-12">
        ...
        <?php echo Html::submitButton('Сохранить', ['name' => 'save', 'class' => 'btn btn-info']); ?>
        <?php echo Html::resetButton('Очистить', ['class' => 'btn btn-danger']); ?>
        <a class="btn btn-primary" href="<?php echo Url::to(['author/index']);?>">Отмена</a>
